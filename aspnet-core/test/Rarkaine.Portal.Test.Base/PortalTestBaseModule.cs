...
using Rarkaine.Portal.Test.Base.DependencyInjection;
using Rarkaine.Portal.Test.Base.UiCustomization;
using Rarkaine.Portal.Test.Base.Url;
using Rarkaine.Portal.Test.Base.Web;
using Rarkaine.Portal.UiCustomization;
...
namespace Rarkaine.Portal.Test.Base
{
    ...
    {
        public PortalTestBaseModule(PortalEntityFrameworkCoreModule portalEntityFrameworkCoreModule)
        {
            portalEntityFrameworkCoreModule.SkipDbContextRegistration = true;
        }
