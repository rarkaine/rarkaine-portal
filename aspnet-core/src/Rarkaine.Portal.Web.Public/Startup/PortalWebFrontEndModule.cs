...
namespace Rarkaine.Portal.Web.Public.Startup
{
    [DependsOn(
    ...
    public class PortalWebFrontEndModule : AbpModule
    {
        ...
        public PortalWebFrontEndModule(IWebHostEnvironment env, PortalEntityFrameworkCoreModule portalEntityFrameworkCoreModule)
        {
