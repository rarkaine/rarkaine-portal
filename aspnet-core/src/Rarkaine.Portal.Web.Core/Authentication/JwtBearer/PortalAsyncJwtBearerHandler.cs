...
{
    public class PortalAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public PortalAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
