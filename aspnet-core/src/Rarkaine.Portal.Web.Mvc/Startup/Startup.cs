...
using Rarkaine.Portal.Schemas;
using Rarkaine.Portal.Web.Chat.SignalR;
using Rarkaine.Portal.Web.Common;
using Rarkaine.Portal.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Rarkaine.Portal.Web.IdentityServer;
using Rarkaine.Portal.Web.Swagger;
using Stripe;
...
using Rarkaine.Portal.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Rarkaine.Portal.Web.Extensions;
using SecurityStampValidatorCallback = Rarkaine.Portal.Identity.SecurityStampValidatorCallback;

namespace Rarkaine.Portal.Web.Startup
{
    public class Startup
    {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Rarkaine.Portal.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                var applicationXml = $"Rarkaine.Portal.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Rarkaine.Portal.Web.Core.xml";
