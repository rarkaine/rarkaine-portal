...
namespace Rarkaine.Portal.Web.Areas.Admin.Views.Shared.Themes.Theme7.Components.AdminTheme7Brand
{
    public class AdminTheme7BrandViewComponent : PortalViewComponent
    {
