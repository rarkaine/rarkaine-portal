...
namespace Rarkaine.Portal.Web.Areas.Admin.Views.Shared.Themes.Theme4.Components.AdminTheme4Footer
{
    public class AdminTheme4FooterViewComponent : PortalViewComponent
    {
